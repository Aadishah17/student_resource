...
The challenge TSV files under `dataset/` are intentionally not published in
the GitHub repository because several individual files exceed GitHub's 100 MB
file limit. Keep the supplied dataset locally beside this repository when
